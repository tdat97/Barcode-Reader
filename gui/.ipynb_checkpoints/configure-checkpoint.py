...
def configure(self):
    ...
    self.run_button['font'] = font.Font(family='Helvetica', size=int(20*self.fsize_factor), weight='bold')
    ...
    self.sub_button1['font'] = font.Font(family='Helvetica', size=int(20*self.fsize_factor), weight='bold')
    ...
    self.sub_button2['font'] = font.Font(family='Helvetica', size=int(20*self.fsize_factor), weight='bold')
